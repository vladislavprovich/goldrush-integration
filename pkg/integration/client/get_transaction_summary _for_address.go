...
func (c *Client) GetTransactionSummaryForAddress(ctx context.Context, req *ReqGetTransactionSummaryForAddress) (*ResGetTransactionSummaryForAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/address/%s/transactions_summary/", req.ChainName, req.WalletAddress),
	}
	...
	var res ResGetTransactionSummaryForAddress
