...
func (c *Client) GetLogEventsByContractAddress(ctx context.Context, req *ReqGetLogEventsByContractAddress) (*ResGetLogEventsByContractAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/events/address/%s/", req.ChainName, req.ContractAddress),
	}
	...
	var res ResGetLogEventsByContractAddress
