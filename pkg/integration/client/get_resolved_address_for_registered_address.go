...
func (c *Client) GetResolverAddressForRegisteredAddress(ctx context.Context, req *ReqGetResolverAddressForRegisteredAddress) (*ResGetResolverAddressForRegisteredAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/address/%s/resolve_address/", req.ChainName, req.WalletAddress),
	}
	...
	var res ResGetResolverAddressForRegisteredAddress
