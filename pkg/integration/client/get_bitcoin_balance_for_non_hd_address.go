...
func (c *Client) GetBitcoinBalancesForNonHDAddress(ctx context.Context, req *ReqGetBitcoinBalancesForNonHDAddress) (*ResGetBitcoinBalancesForNonHDAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/btc-mainnet/address/%s/balances_v2/", req.WalletAddress),
	}
	...
	var res ResGetBitcoinBalancesForNonHDAddress
