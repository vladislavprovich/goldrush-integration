...
func (c *Client) GetHistoricalPortfolioValueOverTime(ctx context.Context, req *ReqGetHistoricalPortfolioValueOverTime) (*ResGetHistoricalPortfolioValueOverTime, error) {
