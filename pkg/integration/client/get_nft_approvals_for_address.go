...
func (c *Client) GetNFTApprovalsForAddress(ctx context.Context, req *ReqGetNFTApprovalsForAddress) (*ResGetNFTApprovalsForAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/nft/approvals/%s/", req.ChainName, req.WalletAddress),
	}
	...
	var res ResGetNFTApprovalsForAddress
