...
func (c *Client) GetBulkTimeBucketForAddress(ctx context.Context, req *ReqGetBulkTimeBucketForAddress) (*ResGetBulkTimeBucketForAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/bulk/transactions/%s/%d/", req.ChainName, req.WalletAddress, req.TimeBucket),
	}
	...
	var res ResGetBulkTimeBucketForAddress
