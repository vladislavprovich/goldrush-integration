...
func (c *Client) GetMultichainBalances(ctx context.Context, req *ReqGetMultichainBalances) (*ResGetMultichainBalances, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/allchains/address/%s/balances/", req.WalletAddress),
	}
	...
	var res ResGetMultichainBalances
