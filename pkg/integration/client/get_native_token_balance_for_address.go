...
func (c *Client) GetNativeTokenBalancesForAddress(ctx context.Context, req *ReqGetNativeTokenBalancesForAddress) (*ResGetNativeTokenBalancesForAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/address/%s/balances_native/", req.ChainName, req.WalletAddress),
	}
	...
	var res ResGetNativeTokenBalancesForAddress
