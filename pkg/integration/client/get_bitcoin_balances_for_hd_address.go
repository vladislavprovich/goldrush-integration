...
func (c *Client) GetBitcoinBalancesForHDAddress(ctx context.Context, req *ReqGetBitcoinBalancesForHDAddress) (*ResGetBitcoinBalancesForHDAddress, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/btc-mainnet/address/%s/hd_wallets/", req.WalletAddress),
	}
	...
	var res ResGetBitcoinBalancesForHDAddress
