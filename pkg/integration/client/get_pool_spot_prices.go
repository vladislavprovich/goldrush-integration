...
func (c *Client) GetPoolSpotPrices(ctx context.Context, req *ReqGetPoolSpotPrices) (*ResGetPoolSpotPrices, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/pricing/spot_prices/%s/pools/%s/", req.ChainName, req.ContractAddress),
	}
