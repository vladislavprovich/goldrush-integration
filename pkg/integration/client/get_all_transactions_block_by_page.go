...
func (c *Client) GetAllTransactionsBlockByPage(ctx context.Context, req *ReqGetAllTransactionsBlockByPage) (*ResGetAllTransactionsBlockByPage, error) {
	urlForGetStatus := &url.URL{
		Scheme: "https",
		Host:   c.cfg.BaseURL,
		Path:   fmt.Sprintf("v1/%s/block/%b/transactions_v3/page/%b/", req.ChainName, req.BlockHeight, req.Page),
	}
	...
	var res ResGetAllTransactionsBlockByPage
