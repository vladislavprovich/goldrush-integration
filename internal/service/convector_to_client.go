...
func (r *ConvectorToClient) ConvectorToRecentAddressTransactionRequest(
	req *RecentAddressTransactionRequest,
) *client.ReqGetRecentTransactionForAddress {
...
func (r *ConvectorToClient) ConvectorToHistoricalPortfolioValueRequest(
	req *HistoricalPortfolioValueRequest,
) *client.ReqGetHistoricalPortfolioValueOverTime {
...
func (r *ConvectorToClient) ConvectorToTokenBalancesRequest(
	req *TokenBalancesRequest,
) *client.ReqGetTokenBalancesForAddress {
...
func (r *ConvectorToClient) ConvectorToTransactionInfoRequest(
	req *TransactionInfoRequest,
) *client.ReqGetTransaction {
